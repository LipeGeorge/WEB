...
const Criar = () => {
    ...
    const [ai, setAi] = useState({es:false, lc:false, mc:false}) //ai = áreas de interesse
            ...
            <form className="form-content" onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        name="nome" //Ela casa o input com a variável. Dá o nome ao name hehe
                        id="inputNome"
                        onChange={handleInputNome} //function defined acima
                    />
                </div>
                ...
                <label className="form-label" htmlFor="inputCurso">Curso</label>
                    <input
                        ...
                        name="curso" 
                        id="inputCurso"
                        onChange={handleInputCurso} //function defined acima
                    />
                </div>

                <div className="mb-3">
                <label className="form-label" htmlFor="inputTitulacao">Titulação</label>
                    <select
